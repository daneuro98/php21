...
<body>
    ...
    <form action="?mod=post&act=update" method="POST" id="form-upload-blog" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="col-md-12" style="margin: auto;">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="short_content" id="short_content" cols="5" rows="5" placeholder="Nhập mô tả ngắn về bài viết"></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <label id="err_content" for="content" style="color: #ff4954; font-size: 14px; display: none;">Vui lòng nhập nội dung bài viết!</label>
              </div>

              <div class="form-group">
                <label>Thể loại: <span style="color: red">*</span></label>
                <select class="form-control" name="category_id" id="category">
                  <option label="Chọn thể loại"></option>
              ...
              <div class="form-group float-right" style="margin-top: 30px">
                <button type="button" class="btn btn-primary" id="btn-preview" data-is-edit="0"><i class="fas fa-pager" style="color: #fff"></i>&nbsp&nbspXem trước</button>
                <button type="submit" class="btn btn-success"><i class="fab fa-telegram-plane" style="color: #fff"></i>&nbsp&nbspĐăng bài</button>
              </div>
            </div>
          </div>
