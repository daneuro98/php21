        ...
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post" href="?mod=post&act=list">
                ...
                <div class="hero-slides-content">
                    ...
                    <a href="?mod=home&act=detail&id=<?=$post['id']?>" class="post-title">
                        <h4 ><td href="?mod=home&act=detail" ><?=$post['title'] ?></td></h4>
                    </a></tr>
                        ...
                        <div id="featured-post-slides" class="carousel slide d-flex flex-wrap" data-ride="carousel">
                                ...
                                <div class="carousel-item active bg-img" style="background-image: url(public/home/img/blog-img<?= $post['thumbnail'] ?>)">
                                    ...
                                    <div class="featured-post-content">
                                        ...
                                        <a href="#" class="post-title">
                                            <h2><td href="?mod=home&act=detail" ><?=$post['title'] ?></td></h2>
                                        </a>
                                    </div>
                                </div>
                                <div class="carousel-item active bg-img" style="background-image: url(public/home/img/blog-img<?= $post['thumbnail'] ?>)">
                            ...
                            <ol class="carousel-indicators">  
                                <li data-target="#featured-post-slides" data-slide-to="0" class="active">
                                    <h2>01</h2>
                                    <a href="?mod=home&act=detail&id=<?=$post['id']?>" class="post-title">
                                        <h5><td href="?mod=home&act=detail"><?=$post['title'] ?></td></h5>
                                    </a>
                                </li>
                    ...
                    <div class="blog-posts-area">
                        ...
                        <div class="single-blog-post d-flex flex-wrap mt-50">
                            ...
                            <div class="post-thumbnail mb-50">
                                <a href="?mod=home&act=detail&id=<?=$post['id']?>">
                            ...
                            <div class="post-content mb-50">
                                ...
                                <a href="?mod=home&act=detail&id=<?=$post['id']?>" class="post-title">
                                    <h4 href="?mod=home&act=detail" ><?= $post['title']?></h4>
                                </a>
                                <div class="post-meta">
                                ...
                                <a href="?mod=home&act=detail&id=<?=$posts['id']?>" class="read-more-btn">Continue Reading <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                            </div>
                            <!-- Post Curve Line -->
